...
RUN_DIR = os.environ.get("ENSEMBLE_REVIEW_REPLAY_DIR", os.path.join(
    REPO, ".agents", "subprojects", "ensemble-review", "reviews", "v1-spec", "2026-09-18-1"))
ARTIFACT = os.environ.get("ENSEMBLE_REVIEW_REPLAY_ARTIFACT", os.path.join(
    REPO, ".agents", "subprojects", "ensemble-review", "design", "v1-spec.md"))
...
class RevisionCheckTest(unittest.TestCase):
    ...
    def copy_run(self, artifact_revision=..., artifact_path=..., with_inputs=False):
        ...
        root = tempfile.mkdtemp(prefix="ensemble-review-revision-")
