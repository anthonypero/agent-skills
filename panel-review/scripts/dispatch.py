...
resolve through `lib/paths.py`'s three-root cascade — `<workspace>/.config/panel-review/` first,
then `~/.config/panel-review/`, then the read-only package — so `--workspace` is the only thing
...
def parse_args(argv):
    ...
    parser.add_argument("--workspace", default=None,
                        help="The project holding the artifact. Files resolve from <workspace>/.config/panel-review/ first, then the skill package (default: the working directory)")
