...
read-only skill package: it drops `.config/panel-review/backends/azure_openai.py` beside its
...
panel-review's personas are single-turn and tool-less:
...
def _load_from_file(path):
    ...
    module_name = "panel_review_backend_" + os.path.basename(absolute)[:-3].replace("-", "_")
