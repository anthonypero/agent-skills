...
`synthesis` dispatches the persona, `harness-judge` ingests what the shipped `panel-judge`
...
def main(argv=None):
    ...
    parser.add_argument("--workspace", default=None,
                        help="The project holding the artifact. Schemas resolve from <workspace>/.config/panel-review/schemas/ first, then the skill package (default: the working directory)")
